...
<!------------------------------ SIDEBAR ------------------------------>
	<section id="sidebar">
		...
		<ul class="side-menu">
			...
			<li><a href="Administrator_comments.php" class="active"><i class='bx bxs-widget icon' ></i>Comments</a></li>
		</ul>
		<div class="ads">
			<div class="wrapper">
...
<!------------------------------ MAIN AND CENTER ------------------------------>
		<main>
			<h1 class="title">Comments Analyses</h1>
			...
			<div class="info-data">
				<iframe title="Dashboard"  height = "550px" width = "100%" src="https://app.powerbi.com/view?r=eyJrIjoiOWQ2MzY5MTQtMjNhNi00YjFiLWFhNWEtMDU5MzI0Mjg2YWJmIiwidCI6IjA1ZjdiNmQxLTJlYWUtNDY3Mi1hZjczLTQ0YWQ4MTgzMTJmOSIsImMiOjEwfQ%3D%3D" frameborder="0" allowFullScreen="true"></iframe>
			</div>
		</main>
	</section>
