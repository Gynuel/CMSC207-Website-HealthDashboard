...
<!------------------------------ SIDEBAR ------------------------------>
	<section id="sidebar">
		...
		<ul class="side-menu">
			<li><a href="Administrator.php"><i class='bx bxs-dashboard icon' ></i>Dashboard</a></li>
			<li class="divider" data-text="Reports"></li>
			<li><a href="Administrator_SERVQUAL.php" class="active"><i class='bx bxs-chart icon' ></i>SERVQUAL</a></li>
...
<!------------------------------ MAIN AND CENTER ------------------------------>
		<main>
			<h1 class="title">SERVQUAL Report</h1>
			<ul class="breadcrumbs">
				<li><a href="#">Reports</a></li>
				<li class="divider">/</li>
				<li><a href="#" class="active">SERVQUAL</a></li>
			</ul>
			<div class="info-data">
				<iframe title="Dashboard"  height = "550px" width = "100%" src="https://app.powerbi.com/view?r=eyJrIjoiMjI5OGZjYTctZGE1Mi00YzRhLTllZWItZDFlMDU0NmRkMTk3IiwidCI6IjA1ZjdiNmQxLTJlYWUtNDY3Mi1hZjczLTQ0YWQ4MTgzMTJmOSIsImMiOjEwfQ%3D%3D" frameborder="0" allowFullScreen="true"></iframe>
			</div>
		</main>
	</section>
